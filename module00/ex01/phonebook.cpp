...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/18 11:53:31 by stitovsk          #+#    #+#             */
/*   Updated: 2025/06/18 12:08:45 by stitovsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "phonebook.hpp"

void PhoneBook::initTheme(Color thm) { theme = thm; }

void PhoneBook::resetIntroTimes() { introTimes = 0; }

void PhoneBook::addContact() {

  if ((count) >= maxNum) {
    if (ind == maxNum) {
      std::cout << theme.getVibr()
                << "You reached the maximum number of contacts!\n"
      ...
      try {
        ...
        std::cerr << theme.getRed() << "Error: " << err.what()
    ...
    try {
      ...
      std::cerr << theme.getRed() << "Error: " << err.what() << theme.getReset()
                << std::endl;
      count--;
      ind--;
    }
...
void PhoneBook::displayPhoneBook() {
  ...
  std::cout << "\n"
            << theme.getCalm() << "|" << std::setw(10) << "Index" << "|"
  ...
  if (res == -1) {
    std::cout << "\n";
    std::cout << theme.getRed()
              << "The wrong input! Introduce a digit that matches the indexes"
              << theme.getRed() << std::endl;
    displayPhoneBook();
    return;
  }
...
void PhoneBook::phoneBookIntro() {
  ...
  std::cout << theme.getBold() << theme.getCalm() << "\n\tWelcome!\n"
            ...
            << "\n\n\t\t" << girlArt << theme.getReset() << std::endl;
}
