...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/18 11:53:11 by stitovsk          #+#    #+#             */
/*   Updated: 2025/06/18 12:07:27 by stitovsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string Color::getWarm() const { return (colorWarm); }

std::string Color::getCalm() const { return (colorCalm); }

std::string Color::getPale() const { return (colorPale); }

std::string Color::getVibr() const { return (colorVibr); }

std::string Color::getRed() const { return (errorRed); }

std::string Color::getBold() const { return (bold); }

std::string Color::getReset() const { return (reset); }